...
const autoCheckpointEveryMessages = 10
...
func shouldAutoCheckpoint(messageCount int) bool {
	if messageCount <= 1 {
		return true
	}
	return messageCount%autoCheckpointEveryMessages == 0
}
